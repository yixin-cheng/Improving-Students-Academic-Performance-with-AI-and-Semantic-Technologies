"""
This file is modified based on the author @blindreviewrepo's work on github
https://github.com/blindreviewrepo/WebAndReligion#run-the-script-scriptsimilarity_fullpy-book_file_1txt-book_file_2txt-output_matrix_filecsv
"""
...
def run(sentences2encode, sentences2compare, fout):
    ...
    with BertClient(port=8190, port_out=5556) as bc:
        doc_vecs = bc.encode(sentences) #sequence embedding
