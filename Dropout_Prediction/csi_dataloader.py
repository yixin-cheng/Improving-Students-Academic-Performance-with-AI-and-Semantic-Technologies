"""
This file is designed for the LSTM implementation in dropout prediction in CSI degree.
"""
...
target_path='data/CSI_clean.csv'
ga_path = 'data/CSI_final.csv'

"""
perform pre-processing. Uncomment below when you try pre-processing.
"""
# Preprocessor(intial_path,target_path,'CSI')
